...
@if ($type)
    <style>
        ...
        html:not(.dark) .kcode-page-banner {
            background: linear-gradient(135deg, rgba(147, 37, 78, 0.08) 0%, rgba(251, 250, 247, 0.85) 100%);
            border: 1px solid rgba(147, 37, 78, 0.2);
        }

        html.dark .kcode-page-banner {
            background: linear-gradient(135deg, rgba(226, 138, 171, 0.09) 0%, rgba(35, 24, 38, 0.7) 100%);
            border: 1px solid rgba(226, 138, 171, 0.18);
        }
        ...
        html:not(.dark) .kcode-banner-info h2 { color: #93254E; }
        html.dark .kcode-banner-info h2 { color: #E28AAB; }
        ...
        html:not(.dark) .kcode-banner-info p { color: #5F565C; }
        html.dark .kcode-banner-info p { color: #C2B5BF; }
        ...
        .orders-stage {
            ...
            height: 44px;
            overflow: hidden;
            border-bottom: 2px dashed rgba(147, 37, 78, 0.35);
        }
        ...
        .box-svg {
            ...
            filter: drop-shadow(0 6px 10px rgba(147, 37, 78, 0.3));
        }
        ...
        .sp-2 { bottom: 0px; left: 5px; color: #93254E; font-size: 0.8rem; animation-delay: 1.2s; }
        ...
        .serum-svg {
            filter: drop-shadow(0 4px 10px rgba(147, 37, 78, 0.4));
        }
                ...
                <div class="orders-stage">
                    <div class="van-wrapper">
                        <svg width="56" height="32" viewBox="0 0 56 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="2" y="4" width="34" height="20" rx="3" fill="#93254E"/>
                            <path d="M36 10H46L52 17V24H36V10Z" fill="#6B2F5F"/>
                            <path d="M39 12H44L48 17H39V12Z" fill="#FBFAF7"/>
                            <rect x="51" y="19" width="3" height="3" rx="1" fill="#fbbf24"/>
                            <line x1="13" y1="4" x2="13" y2="24" stroke="#2E1633" stroke-width="1.5"/>
                            <g class="wheel-rotate">
                                <circle cx="13" cy="24" r="5" fill="#1e293b" stroke="#93254E" stroke-width="2"/>
                                <circle cx="13" cy="24" r="2" fill="#cbd5e1"/>
                            </g>
                            <g class="wheel-rotate">
                                <circle cx="42" cy="24" r="5" fill="#1e293b" stroke="#93254E" stroke-width="2"/>
            ...
            @elseif ($type === 'products' || $type === 'categories' || $type === 'sub_categories' || $type === 'brands')
                ...
                <div class="products-stage">
                    ...
                    <svg class="box-svg" width="46" height="42" viewBox="0 0 46 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M23 4L42 13V29L23 38L4 29V13L23 4Z" fill="#93254E" opacity="0.85"/>
                        <path d="M23 4L42 13L23 22L4 13L23 4Z" fill="#E28AAB"/>
                        <path d="M23 22V38L4 29V13L23 22Z" fill="#6B2F5F"/>
                        <path d="M23 22L42 13V29L23 38V22Z" fill="#2E1633"/>
                    </svg>
            ...
            @elseif ($type === 'users' || $type === 'roles')
                ...
                <div class="users-stage">
                    ...
                    <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="21" cy="14" r="7" fill="#93254E"/>
                        <path d="M7 34C7 27.3726 13.268 22 21 22C28.732 22 35 27.3726 35 34V36H7V34Z" fill="#6B2F5F"/>
                    </svg>
                </div>
            ...
            @elseif ($type === 'skincare' || $type === 'assessments' || $type === 'concerns' || $type === 'quiz_questions' || $type === 'skin_types')
                ...
                <div class="skincare-stage">
                    ...
                    <svg class="serum-svg" width="36" height="42" viewBox="0 0 36 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect x="14" y="2" width="8" height="6" rx="2" fill="#E28AAB"/>
                        <path d="M12 8H24V13H12V8Z" fill="#93254E"/>
                        <rect x="8" y="13" width="20" height="26" rx="4" fill="#6B2F5F"/>
                        <rect x="11" y="17" width="14" height="18" rx="2" fill="#FBFAF7" opacity="0.3"/>
                    </svg>

...
class ProductResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            // Product Details
            'texture' => app()->getLocale() == 'ar' ? $this->texture_ar : $this->texture_en,
            'texture_ar' => $this->texture_ar,
            'texture_en' => $this->texture_en,
            'why_kcode' => app()->getLocale() == 'ar' ? $this->why_kcode_ar : $this->why_kcode_en,
            ...
            'safety_notes' => app()->getLocale() == 'ar' ? $this->safety_notes_ar : $this->safety_notes_en,
            'safety_notes_ar' => $this->safety_notes_ar,
            'safety_notes_en' => $this->safety_notes_en,
            'key_benefits' => app()->getLocale() == 'ar' ? $this->ar_key_benefits : $this->en_key_benefits,
